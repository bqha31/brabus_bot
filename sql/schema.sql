...
-- columns (category, sort_order, is_active, duration_minutes, time_range,
-- cancelled_at) to tables that already exist. If you already ran the old
-- schema, the simplest path for a test project is to drop and recreate:
